export const state = () => ({
  ...
  english: {
    header: {
      title: "Khaled Al-Sahethi for Pharmaceuticals and Medical Supplies",
      description:
      ...
      links: [
        { name: "Home", icon: "mdi-google-home", to: "#hii" },
        {
          name: "About Us",
          icon: "mdi-text-box-multiple-outline",
          to: "#about-us"
    ...
    aboutus: {
      title: "About Us",
      description:
        "We are leading companies in Yemeni market working in the field of pharmaceuticals and health products since its establishment in 2020. Promoting products and distributing them to the entire Yemeni market. Starting in 2022, Khaled Al-Shahethi Medical has made a long history as one of the major players in the health market. Khaled El-Shahethi Medical knows how to create a demand for products and how to make these products available everywhere near the consumer's hand. Khaled El-Shahethi Medical is managed through a well-organized corporate structure that aligns with our goals and objectives. Our qualified employees carry out the task and achieve the goals using all the facilities offered by the company. The Human Resources Unit provides modern management strategies.",
      mores: [
        {
          name: " Our Mission",
          details:
            "Making this statement our goal and always looking for the best for our customers and how we can deliver more than what our customers expect, is one of our most important values ​​that every employee in our company lives every day and this is what made us the first choice for people when it comes to providing pharmaceutical and health care products and services. Khaled El-Shahdy Medical Company specializes in providing high quality pharmaceutical and healthcare products at competitive prices to the Middle East and Southeast Asian markets. By building Khaled El-Shahdy Medical Company as a brand name that makes people their first choice when it comes to pharmaceutical and healthcare products. We were able to be a leading company in the Middle East and South Asian markets, and our brand name was synonymous with trust and reliability.",
          icon: "https://assets1.lottiefiles.com/private_files/lf30_RfOqwp.json"
        },
        {
          name: "Our Vision",
          details:
            "Belief in quality, teamwork, integrity and respect We seek to arrange in the first place the import, distribution and marketing of medicines and medical devices",
          icon: "https://assets2.lottiefiles.com/packages/lf20_omszt4va.json"
        },
        {
          name: "Our values",
          details:
            "<span>towards the community<span><br>Providing products and services that lead to a comfortable, safe and better life for people<br><span>towards the staff<span><br>To ensure the complete satisfaction of our employees by providing the best work environment<br><span>towards the environment<span><br>Prioritizing the environment diet through eco-friendly products and services",
          icon: "https://assets4.lottiefiles.com/packages/lf20_jcyhxkau.json"
        }
      ]
    },
    service: {
      title: "Our services",
      description:
        "Khaled Al-Shahethi Medical Company participates in all sales as well as in tenders, import and registration affairs, marketing, promotion and distribution.",
      mores: [
        {
          name: "import",
          details:
            "We are well acquainted with the characteristics of the market and we introduce new varieties as we import medicines needed by the market from Europe, India and the Middle East",
          icon: "mdi-airplane-takeoff"
        },
        {
        ...
        },
        {
          ...
          details:
            "We have good experience in the field of selling and marketing products and we have strong relationships in the market through our knowledge of our strengths and the quality of the products being promoted and we target doctors, pharmacies and cosmetic experts",
          icon: "mdi-cart-variant"
        },
        {
          name: "distribution",
          details:
            "We have an independent department for distribution where we train, qualify and provide technical support to distributors for good relations with customers and work to create demand for products",
          icon: "mdi-handshake"
        }
      ]
    },
    agents: {
      ...
      description:
        "For pharmaceutical factories and companies that do not have agents in Yemen, we are ready to deal with them and meet all requirements to take the agency and we will be the best representative for them and we will make their products of great importance and more consumption in the Yemeni markets, here you can write to us through the following email of the company, thanking you for your cooperation and trust in us.",
      email: ""
    },
    whyus: {
